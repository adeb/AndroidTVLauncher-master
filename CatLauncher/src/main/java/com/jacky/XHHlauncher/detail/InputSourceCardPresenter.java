...
public class InputSourceCardPresenter extends Presenter {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, Object item) {
        ...
        InputSourceModel inputsourcemodel = (InputSourceModel) item;
        cardView.setMainImageScaleType(ImageView.ScaleType.CENTER_INSIDE);
        cardView.getMainImageView().setImageResource(inputsourcemodel.getIcon());
        cardView.setTitleText(inputsourcemodel.getTitle());
        cardView.setContentText(inputsourcemodel.getContent());
    }
