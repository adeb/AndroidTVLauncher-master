...
public class WeatherCardPresenter extends Presenter {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, Object item) {
        ...
        WeatherModel weatherModel = (WeatherModel) item;
        cardView.setMainImageScaleType(ImageView.ScaleType.CENTER_INSIDE);
        cardView.getMainImageView().setImageResource(weatherModel.getIcon());
        cardView.setTitleText(weatherModel.getTitle());
        cardView.setContentText(weatherModel.getContent());
